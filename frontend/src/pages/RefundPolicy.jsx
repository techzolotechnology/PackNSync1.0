            ...
            <div className="container refund-container">
                <header className="refund-header">
                    ...
                    <p className="refund-summary">
                        How cancellations, wallet credits, rental bookings, and payment reversals work on PickAndSync.
                    </p>
                ...
                <article className="refund-content card">
                    <section className="refund-section">
                        <h2>1. Overview</h2>
                        <p>
                            This Refund Policy explains how <strong>PickAndSync</strong>, operated by{' '}
                        ...
                        <p>
                            By using PickAndSync, you agree to this policy together with our{' '}
                    ...
                    <section className="refund-section">
                        ...
                        <ul>
                            ...
                            <li><strong>PickAndSync Wallet</strong> — in-app balance topped up via Cashfree and used for eligible bookings.</li>
                        </ul>
                        <p>
                            PickAndSync does not store your full card number or card security code. Refunds are
                    ...
                    <section className="refund-section">
                        ...
                        <ul>
                            <li>Successful wallet top-ups are credited to your PickAndSync wallet immediately after payment confirmation.</li>
                    ...
                    <section className="refund-section">
                        ...
                        <ul>
                            ...
                            <li><strong>Host cancellation</strong> — If a host cancels a confirmed booking, you are entitled to a full refund of amounts paid through PickAndSync for that booking.</li>
                    ...
                    <section className="refund-section">
                        <h2>5. Group trips</h2>
                        <p>
                            PickAndSync helps groups plan trips and split expenses. Trip membership itself is free unless
                            ...
                            PickAndSync unless tied to a platform payment.
                        </p>
                    </section>
                    ...
                    <section className="refund-section">
                        ...
                        <p>
                            ...
                            their policies. PickAndSync does not process refunds for rides completed or cancelled
                    ...
                    <section className="refund-section">
                        ...
                        <ul>
                            <li>Approved refunds are initiated by PickAndSync or our payment partner (Cashfree).</li>
                            ...
                            <li>Wallet refunds are credited back to your PickAndSync wallet balance and are usually available immediately.</li>
