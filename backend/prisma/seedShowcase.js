...
const HOSTS = [
    ...
    },
    {
        ...
        name: 'Meera Iyer',
        city: 'Chennai',
        bio: 'Tea estates, slow mornings, and long drives.',
...
async function seed() {
    ...
    for (const spec of VEHICLES) {
        ...
        const vehicle = await prisma.vehicle.upsert({
            where: { licensePlate },
            update: { ...vehicleData, isVerified: true },
            create: { ...vehicleData, licensePlate, type: 'CAR', isVerified: true, ownerId: owner.id },
        });
